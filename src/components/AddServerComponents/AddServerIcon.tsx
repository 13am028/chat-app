...
const AddServerIcon = ({ onGroupCreate }: Props) => {
    ...
    return (
        <div>
            <button onContextMenu={handleContextMenu} onClick={handleShow} className="addServerIcon">
            ...
            <Modal show={showModal} onHide={handleClose} centered>
                ...
                <Modal.Body className="addServerModalBody">
                    ...
                    <form>
                        <label className="addServerModalBodyFormHeader">SERVER NAME</label>
                        <input className="addServerModalBodyFormContent" placeholder='server name' type='text'
                        onChange={handleGroupNameChange} value={groupName}/>
                    </form>
                </Modal.Body>

                <Modal.Footer className="addServerModalFooter">
                    <Button onClick={handleCreateGroup} className="addServerModalFooterButton" disabled={!groupName.trim()}>
                        Create
                    </Button>
                </Modal.Footer>
