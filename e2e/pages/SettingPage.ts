...
export default class SettingPage {
    ...
    async checkSideBar() {
        ...
        await expect(this.page.getByRole('link', { name: 'Activity Privary' })).toBeVisible();
        await expect(this.page.getByText('Activity PrivaryRegistered Games')).toBeVisible();
    ...
    async checkProfileSetting() {
        ...
        await expect(this.page.getByRole('heading', { name: 'Change Avatar' })).toBeVisible();
        await expect(this.page.getByTestId('upload-image-button').locator('div').first()).toBeVisible();
        await this.page.getByTestId('upload-image-button').locator('div').first().click();
        ...
        await expect(this.page.locator('div').filter({ hasText: /^Change AvatarJohndow$/ }).locator('span')).toBeVisible();
        await expect(this.page.getByRole('heading', { name: 'USERNAME' })).toBeVisible();
        await expect(this.page.locator('div').filter({ hasText: /^Johndow$/ }).locator('span')).toBeVisible();
        ...
        await expect(this.page.getByRole('heading', { name: 'Password and Authentication' })).toBeVisible();
        ...
        await expect(this.page.getByText('Protect your Discord account with an extra layer of security. Once configured, y')).toBeVisible();
